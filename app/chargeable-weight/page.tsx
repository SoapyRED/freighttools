...
export default function ChargeableWeightPage() {
  return (
    <>
      ...
      <PageHero title="Chargeable Weight" titleAccent="Calculator" subtitle="Compare actual vs volumetric weight for air and sea freight" differentiators={['IATA 6000 divisor', 'Actual vs volumetric', 'Free API']} />
