...
const ogUrl = '/api/og?title=Airline+Codes+%26+AWB+Prefix+Lookup&desc=Search+' + '6,335' + '+airlines+by+name,+code,+or+AWB+prefix&api=GET+/api/airlines';

export const metadata: Metadata = {
  title: 'Airline Codes & AWB Prefix Lookup | FreightUtils',
  description: 'Free airline code and AWB prefix lookup. Search 6,335 airlines by name, IATA code, ICAO code, or three-digit AWB prefix. Includes 268 cargo airlines with AWB prefixes. Free REST API.',
