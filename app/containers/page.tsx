...
export default function ContainersPage() {
  ...
  return (
    <>
      ...
      <PageHero title="Container" titleAccent="Specs" subtitle="Shipping container dimensions, weights, door openings, and pallet capacity" differentiators={['10 ISO container types', 'Pallet counts', 'Free API']} />
