...
export default function ContainersPage() {
  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: breadcrumbSchema([{ name: 'Container Specs', path: '/containers' }]) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"Container Capacity Calculator","description":"Free Container Capacity Calculator. Internal dimensions, weights, door openings, and pallet capacity for all standard container types. REST API available.","url":"https://www.freightutils.com/containers","applicationCategory":"UtilityApplication","operatingSystem":"All","offers":{"@type":"Offer","price":"0","priceCurrency":"GBP"},"author":{"@type":"Person","name":"Marius Cristoiu","url":"https://www.linkedin.com/in/marius-cristoiu-a853812a2/"}}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between a 40ft standard and 40ft high cube?","acceptedAnswer":{"@type":"Answer","text":"A 40ft high cube is 1 foot (30 cm) taller internally — 2.69m vs 2.39m. This extra height adds about 8.6 CBM of capacity. High cubes are the most commonly used container for general cargo."}},{"@type":"Question","name":"How much does an empty shipping container weigh?","acceptedAnswer":{"@type":"Answer","text":"A 20ft standard weighs about 2,300 kg empty (tare weight). A 40ft standard is about 3,750 kg. A 40ft high cube is about 3,940 kg."}},{"@type":"Question","name":"Can I load a container to its maximum capacity?","acceptedAnswer":{"@type":"Answer","text":"The maximum gross weight includes the container's own weight. Road weight limits in many countries are lower than the container's structural maximum, so the road limit often governs."}},{"@type":"Question","name":"What is a reefer container?","acceptedAnswer":{"@type":"Answer","text":"A reefer is a refrigerated container with built-in cooling/heating. Internal dimensions are slightly smaller due to insulation. Used for perishable goods requiring temperature control."}}]}) }} />
      <PageHero title="Container" titleAccent="Specs" subtitle="Shipping container dimensions, weights, door openings, and pallet capacity" differentiators={['10 ISO container types', 'Pallet counts', 'Free API']} category="ops" />

      <main data-category="ops" style={{ maxWidth: 960, margin: '0 auto', padding: '32px 20px 80px' }}>
