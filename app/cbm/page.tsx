...
export default function CbmPage() {
  return (
    <>
      ...
      <PageHero title="CBM" titleAccent="Calculator" subtitle="Calculate cubic metres for sea freight, air freight, and container loading" differentiators={['10 container types', 'Sea & air freight', 'Free API']} />
