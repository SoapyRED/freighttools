  ...
  return (
    <div style={{ minHeight: 'calc(100vh - 200px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
      <div style={{ textAlign: 'center', maxWidth: 480 }}>
        <div style={{ fontSize: 80, fontWeight: 800, color: '#e87722', lineHeight: 1, marginBottom: 8 }}>404</div>
        ...
        <p style={{ fontSize: 15, color: 'var(--text-muted)', lineHeight: 1.6, marginBottom: 28 }}>
          The page you&apos;re looking for doesn&apos;t exist or has been moved. Try one of the tools below:
        </p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 28 }}>
          {[
            ...
            <Link key={t.href} href={t.href} style={{
              ...
              <span style={{ color: '#e87722', fontWeight: 600 }}>{t.href}</span>
        ...
        <Link href="/" style={{
          ...
          background: '#e87722', color: '#fff', fontWeight: 700, fontSize: 15,
          textDecoration: 'none',
        }}>
          Back to homepage
        </Link>
