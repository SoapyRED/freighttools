...
export default function AdrPage() {
  ...
  return (
    <>
      ...
      <PageHero title="ADR Dangerous Goods" titleAccent="Lookup" subtitle="Search dangerous goods by UN number, substance name, or hazard class" badge="ADR 2025" differentiators={['2,939 ADR 2025 entries', 'Free API', 'No signup required']} category="dg" />
