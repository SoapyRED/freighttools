...
export default function IncotermsPage() {
  ...
  return (
    <>
      ...
      <PageHero title="INCOTERMS" titleAccent="2020" subtitle="International commercial terms — who pays, who bears risk, where responsibility transfers" differentiators={['All 11 rules', 'Buyer vs seller breakdown', 'Free API']} category="customs" />
