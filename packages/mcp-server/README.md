...
All tools call the free [FreightUtils API](https://www.freightutils.com/api-docs). Courtesy rate limit: 25 requests/day per IP (no key needed). Register a free API key for 100 requests/day.
